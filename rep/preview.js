...
function getURL (params) {
  return 'http://api.larepubliquedespyrenees.fr/004/articles/read/?articleid=' + params.articleId + '&appid=REP-Wjp9Eirnv8'
}
...
function formatDate (date) {
  return [
    ...
    date.getFullYear(),
    'à',
    fill(String(date.getHours())) + 'h' + fill(String(date.getMinutes()))
  ].join(' ')
}
